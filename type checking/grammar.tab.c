...
#line 110 "grammar.tab.c" /* yacc.c:339  */
...
{
       0,    92,    92,    93,    96,    97,    98,   101,   102,   105,
     108,   109,   110,   112,   113,   114,   117,   118,   133,   136,
     137,   138
};
#endif
...
{
  "$end", "error", "$undefined", "T_INTEGER", "T_REAL", "ADD", "MINUS",
  "MUL", "DIV", "ASSIGN", "C_REAL", "C_INTEGER", "VAR", "L_PARENTHESIS",
  "R_PARENTHESIS", "STRING", "PLUS", "$accept", "program", "code",
  "declaration", "computation", "expression", "math", "var_const", "const", YY_NULLPTR
};
#endif
...
{
       0,   -10,     5,    12,     7,     0,   -11,   -11,   -11,   -11,
       3,   -11,   -11,   -11,   -11,   -11,     3,   -11,    -5,    -2,
     -11,   -11,    -6,     3,     3,     3,     3,   -11,    -2,    -2,
     -11,   -11
};
...
{
       2,     0,     0,     6,     0,     2,     4,     5,     7,     8,
       0,     1,     3,    19,    20,    17,     0,    21,     9,    12,
      15,    16,     0,     0,     0,     0,     0,    18,    11,    10,
      13,    14
};
...
{
     -11,     4,   -11,   -11,   -11,     8,    -4,    -3,   -11
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     4,     5,     6,     7,    18,    19,    20,    21
};
...
{
      23,    23,     8,     1,     2,    25,    26,    11,    27,    12,
      24,    24,     3,    13,    14,    15,    16,     9,    17,    28,
      29,    10,    30,    31,    22
};

static const yytype_uint8 yycheck[] =
{
       6,     6,    12,     3,     4,     7,     8,     0,    14,     5,
      16,    16,    12,    10,    11,    12,    13,    12,    15,    23,
      24,     9,    25,    26,    16
};
...
{
       0,     3,     4,    12,    18,    19,    20,    21,    12,    12,
       9,     0,    18,    10,    11,    12,    13,    15,    22,    23,
      24,    25,    22,     6,    16,     7,     8,    14,    23,    23,
      24,    24
};
...
#line 112 "grammar.y" /* yacc.c:1646  */
    {(yyval.exp) = typecheck((yyvsp[-2].exp),(yyvsp[0].exp),MU); }
#line 1319 "grammar.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 113 "grammar.y" /* yacc.c:1646  */
    {(yyval.exp) = typecheck((yyvsp[-2].exp),(yyvsp[0].exp),DI); }
...
#line 118 "grammar.y" /* yacc.c:1646  */
    {
							struct node *v = find((yyvsp[0].str))->v; 
							(yyval.exp).t = v->t;
							switch((yyval.exp).t){
								case STR:
									(yyval.exp).value.s = v->value.s;
									break;
								case INT:
									(yyval.exp).value.i = v->value.i;
									break;
								case REAL:
									(yyval.exp).value.f = v->value.f;
												break;
							}
							}
...
#line 136 "grammar.y" /* yacc.c:1646  */
    {(yyval.exp).t = REAL; (yyval.exp).value.f = (yyvsp[0].f);}
#line 1369 "grammar.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 137 "grammar.y" /* yacc.c:1646  */
    {(yyval.exp).t = INT; (yyval.exp).value.i = (yyvsp[0].i);}
#line 1375 "grammar.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 138 "grammar.y" /* yacc.c:1646  */
    {(yyval.exp).t = STR; (yyval.exp).value.s = (yyvsp[0].str);}
